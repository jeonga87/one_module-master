...
import com.example.demo.config.mybatis.interceptor.CurrentInterceptor;
...
public abstract class MyBatisConfiguration {
    ...
    public static final String TYPE_ALIASES_PACKAGE = "com.example.demo";
    public static final String TYPE_HANDLER_PACKAGE = "com.example.demo.config.mybatis.type";
...
@Configuration
@MapperScan(basePackages = "com.example.demo.**.repository", annotationClass = Repository.class, sqlSessionFactoryRef = "defaultSqlSessionFactory")
