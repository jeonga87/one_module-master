...
import com.example.demo.attach.domain.Attach;
...
public class AttachController extends BaseFormController {
     ...
     * @return 첨부파일 객체
     */
    @RequestMapping(value = URI_PREFIX + "/{refType}/{refKey}",
     ...
     * @throws Exception
     */
    @RequestMapping(value = URI_PREFIX + "/view/{attachNo}",
            method      = RequestMethod.GET)
    public void view(@PathVariable("attachNo") Long attachNo,
    ...
    public void download(@PathVariable("attachNo") Long attachNo,
                         HttpServletResponse response) throws Exception {
        Attach attach = attachService.getAttach(attachNo);
